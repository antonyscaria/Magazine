 ...
 if(isset($_POST['submit']))
 {
    ...
    if($password==$cpassword)
    {
       ...
       if (mysqli_num_rows($isExist) ==0)
        {
          $sql1="INSERT INTO `stud_reg`( `firstname`, `lastname`, `email`, `course`, `password`) VALUES  ('$fname', '$lname','$email','$course','$password')";
                                    ...
                                    <div class="card-body">
                                        <form method='post'>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" name="inputcourse" type="text"  placeholder="Enter Course" required />
                                            </div>
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
